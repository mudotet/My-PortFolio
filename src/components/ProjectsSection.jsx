...
const projects = [
  {
    ...
    description:
      "A modern SaaS landing page built with React and Tailwind CSS, showcasing features and pricing plans.",
    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mt-12">
            <a href="https://github.com/mudotet" target="_blank" className="cosmic-button w-fit flex items-center mx-auto gap-2">
